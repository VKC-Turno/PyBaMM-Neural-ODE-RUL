...
forecasting model uniformly across heterogeneous second-life cells. For
new cells, the shortened inference protocol reduces the testing window
by approximately 60\% compared with the four-week comprehensive
characterisation programme required for anchor-cell development.
