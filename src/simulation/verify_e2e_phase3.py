...
parameters + fitted degradation parameters for EVE cell 0008.
...
Outputs (under data/synthetic/verification/):
    eve_0008_longrun.parquet
    eve_0008_workflow_validation.png
    eve_0008_phase3_log.txt
"""
...
LONGRUN_PARQUET = OUT_DIR / "eve_0008_longrun.parquet"
VAL_PLOT = OUT_DIR / "eve_0008_workflow_validation.png"
LOG_TXT = OUT_DIR / "eve_0008_phase3_log.txt"
...
def make_validation_plot(df_sim: pd.DataFrame, df_meas: pd.DataFrame,
    ...
    ax_main.scatter(df_meas["cycle_n"], df_meas["soh"] / df_meas["soh"].iloc[0],
                    c="k", s=14, label="Measured EVE 0008 (norm)")
    ...
    ax_main.set_title("End-to-end workflow validation: EVE cell 0008\n"
...
def main() -> dict:
    ...
    # save summary yaml
    with open(OUT_DIR / "eve_0008_phase3_summary.yaml", "w") as f:
